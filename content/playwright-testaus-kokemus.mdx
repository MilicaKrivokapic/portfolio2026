---
title: "Playwright-testauskokemus: Portfolion automaattinen testaaminen"
publishedAt: "2026-01-06"
summary: "Kokemus Playwright-testien luomisesta"
tags: "Finnish, testing, Playwright, automation, CI/CD"
...
Latasin extensionin, ja katsoin hyvän opetusvideon Playwrightista. (linkki) Aloin jutella kalliin Claude-mallin kanssa samalla kun lisäosa asentui.
...
Tuntui, että Playwrigthin virittäminen johonkin tälläiseen kepoisaan repoon kuten portfoliosivuille voi olla vähän overkilliä. Toisaalta, koen että opin tästä todella paljon, ja innoistuin automaatioista.

Seuravaaksi voisin virittää automaattisia Cypress-testejä. Ja ehkä jonkinlainen oikeinkirjoitus-testaus olisi myös hyvä, löydän ihan jatkuvasti typoja täältä blogista. :D
