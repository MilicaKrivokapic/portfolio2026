...
Tuntui, että Playwrightin virittäminen johonkin tälläiseen kepoisaan repoon kuten portfoliosivuille voi olla vähän overkilliä. Toisaalta, koen että opin tästä todella paljon, ja innoistuin automaatioista.

Seuraavaksi voisin virittää automaattisia Cypress-testejä. Ja ehkä jonkinlainen oikeinkirjoitus-testaus olisi myös hyvä, löydän ihan jatkuvasti typoja täältä blogista. :D
