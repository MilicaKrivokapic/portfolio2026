type SquareUpRightProps = {
  className?: string;
  title?: string;
};

export default function SquareUpRight({ className = 'w-4 h-4 md:w-5 md:h-5 transition-transform duration-200 ease-out group-hover:translate-x-0.5 group-hover:-translate-y-0.5', title }: SquareUpRightProps) {
