...
export default function UpRightFromSquareSolidFull({ className = "w-5 h-5", title }: IconProps) {
  const ariaProps = title ? { role: 'img', 'aria-label': title } : { 'aria-hidden': true } as const;
  return (
    <svg
