    ...
    return (
      <>
        ...
        <button
          ...
          disabled
        >
          {/* Sun when dark mode (mirrors real component's logic) */}
          <svg
            viewBox="0 0 16 16"
            className="hidden dark:block w-[20px] h-[20px] text-accent-light dark:text-accent-dark"
            fill="currentColor"
          ...
          <svg
            viewBox="0 0 16 16"
            className="block dark:hidden w-[20px] h-[20px] text-accent-light"
            fill="currentColor"
            xmlns="http://www.w3.org/2000/svg"
            aria-hidden
          >
        ...
        <div className="hidden md:flex items-center gap-3 rounded-md border bg-white dark:bg-background-dark border-gray-200 dark:border-gray-700 p-2" aria-hidden>
          ...
          {/* Toggle lookalike (no input, CSS mirrors dark state) */}
          <div className="relative inline-block">
            {/* Track */}
            <span className="block w-[140px] h-[34px] bg-[#E0E0E0] rounded-[26px] overflow-hidden motion-safe:transition-colors motion-safe:duration-300 dark:bg-[#2a2a2a] border border-black/10 dark:border-white/10" />
            {/* Knob */}
            <span className="pointer-events-none absolute left-[2px] top-[2px] w-[70px] h-[30px] bg-white rounded-[26px] shadow-[0_0_6px_-2px_#111] text-center motion-safe:transition-all motion-safe:duration-300 dark:left-[68px] dark:bg-[#3c3c3c]" />
            {/* Labels */}
            <span aria-hidden="true" className="pointer-events-none absolute top-[7px] left-5 text-[12px] font-medium text-[#424242] motion-safe:transition-colors motion-safe:duration-300 dark:text-white">
              Light
            </span>
            <span aria-hidden="true" className="pointer-events-none absolute top-[7px] right-5 text-[12px] font-medium text-[#424242] motion-safe:transition-colors motion-safe:duration-300 dark:text-white">
              Dark
            </span>
          </div>
