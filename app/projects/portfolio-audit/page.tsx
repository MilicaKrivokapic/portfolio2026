...
export default function PortfolioAudit() {
  ...
  const t = translations[language].portfolioAudit;
          ...
          <div className="mb-4">
            <nav aria-label="Breadcrumb" className="text-sm md:text-base text-neutral-500 dark:text-neutral-400">
              <ol className="flex items-center gap-2">
                ...
                <li aria-hidden="true" className="opacity-60">/</li>
                <li className="truncate max-w-[50vw] md:max-w-none" aria-current="page">
                  {language === 'fi' ? 'Portfolion saavutettavuusauditointi' : 'Portfolio Accessibility Audit'}
                </li>
              </ol>
            </nav>
          </div>
