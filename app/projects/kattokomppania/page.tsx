...
export default function KattokomppaniaProject() {
  ...
  const content = {
    en: {
      ...
      subtitle:
        "A comprehensive website redesign project for a Finnish roofing company, focusing on improving user experience and digital presence.",
      overview: {
      ...
      title: "Kattokomppania",
      subtitle:
        "Kattava verkkosivuston uudistusprojekti suomalaiselle kattoalan yritykselle, keskittyen käyttäjäkokemuksen ja digitaalisen läsnäolon parantamiseen.",
      overview: {
        title: "Projektista",
        text: [
            ...
            <section>
              ...
              <div className="space-y-4">
                <p className="text-base sm:text-lg leading-relaxed">
                  {currentContent.overview.text[0]}
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
                  <button
                    onClick={() =>
                      setSelectedImage("/kattokomppania design.png")
                    }
                  ...
                  <button
                    onClick={() =>
                      setSelectedImage("/kattokomppania_design2.png")
                    }
                    className="relative w-full aspect-[4/3] rounded-lg overflow-hidden shadow-lg border border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-800 cursor-pointer hover:opacity-90 transition-opacity focus:outline-none focus:ring-2 focus:ring-accent-light dark:focus:ring-accent-dark focus:ring-offset-2"
                ...
                <p className="text-base sm:text-lg leading-relaxed">
                  {currentContent.overview.text[1]}
                </p>
              </div>
            </section>
