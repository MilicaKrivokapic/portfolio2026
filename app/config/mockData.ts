export const projectData = [
  ...
  },
  {
    ...
    description:
      "First steps with Playwright - building smoke tests for this portfolio to learn automated testing.",
    description_fi:
      "Ensimmäiset askeleet Playwrightin kanssa - smoke-testien rakentaminen tälle portfoliolle.",
  ...
  },
  {
    ...
    description_fi:
      "Saavutettavuusraportti Briljantin verkkosivuston parantamiseksi käytännön WCAG 2.2 -suosituksilla.",
    image: "/briljant.png",
  ...
  },
  {
    ...
    description:
      "Accessibility audit for site rating and documenting Helsinki's most iconic and most horrid public restrooms.",
    image: "/toiletten.jpg",
...
export const socialData = [
  {
    name: "GitHub",
    url: "https://github.com/MilicaKrivokapic",
    icon: "FaGithub",
  },
  { name: "LinkedIn", url: "https://www.linkedin.com/", icon: "FaLinkedin" },
  {
    name: "Email",
    url: "mailto:Milica.portfolio@proton.me",
    icon: "TbMailFilled",
  },
];
...
export interface MultilingualRecommendation extends Omit<
  Recommendation,
  "text" | "role" | "email"
> {
  role: {
...
export const recommendationsData: MultilingualRecommendation[] = [
  ...
  },
  {
    ...
    text: {
      ...
      fi: "Milica on työkaverina huomaavainen ja useista näkökulmista asioita tarkasteleva, tämä rikastuttaa yhteistyötä. Hän tekee huolella ja tarkkuudella töitä ja pystyy perustelemaan valitsemansa ratkaisut asiantuntevasti ja myös keskustellen eri painopisteistä sekä näkökulmista. Hän on myös mukava ja ystävällinen muita kohtaan :) ",
    },
    icon: "seahorse",
  },
  {
